...
This is an Angular Starter Kit for using Tailkit - https://tailkit.com UI components out of the box in your project.

```
Requirements: node.js

Installation: npm install -g @angular/cli && npm install
